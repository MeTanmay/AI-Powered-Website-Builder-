...
function Pricing() {
  ...
  return (
    ...
    <div className='mt-10 flex flex-col items-center w-full p-10 md:px-32 lg:px-45'>
      <h2 className='font-bold text-5xl'>Pricing</h2>
      <p className='text-gray-400 max-w-xl text-center mt-4'>{Lookup.PRICING_DESC}</p>
      <div className='p-5 border rounded-xl flex justify-between w-full mt-7 items-center'
      style={{
