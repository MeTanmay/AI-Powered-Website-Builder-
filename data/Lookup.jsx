...
`
  ...
  PRICING_OPTIONS:[
    ...
    },
    {
      ...
      tokens:'120K',
      value:120000,
      desc:'Perfect for regular users who need consistent access to the tool.',
      price:9.99
    },
    {
      name:'Pro',
      tokens:'2.5M',
      value:2500000,
      desc:'Designed for professionals who need to use it a frequently.',
      price:19.99
    },
    {
      name:'License',
      tokens:'Unlimited',
      value:999999999,
      desc:'Tailored for power users and teams needing full-scale performance.',
      price:49.99
    }
  ]
